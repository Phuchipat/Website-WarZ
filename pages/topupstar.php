                                ...
                                <div class="col-xs-12">
                                    ...
                                    <center>
                                        <div class="col-md-5">
                                            ...
                                            <input name="ref3" class="form-control" value="3" type="hidden" id="ref3" readonly />
                                                    <br>
                                            ...
                                            <table border="1" align="center" class="table table-bordered">
                                                <thead class="font14 thead-inverse">
                                                    <tr>
                                                        ...
                                                        <th class="text-center">
                                                            <h5 class="section-title"><span style="color:#FFF">DAY
                                                                    (จำนวนวันที่ได้)</span></h5>
                                                        </th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">';echo number_format($tmt_star50) ;;echo ' CP
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">';echo number_format($tmt_star90) ;;echo ' CP
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">';echo number_format($tmt_star150) ;;echo ' CP
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">';echo number_format($tmt_star300) ;;echo ' CP
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">';echo number_format($tmt_star500) ;;echo ' CP
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">';echo number_format($tmt_star1000) ;;echo ' CP
                                                            </td>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <a href="#promotion" data-toggle="modal"><img
                                                    src="';echo $photostar ;;echo '" class="img-rounded" width="100%"
                                                    height="100%"></a>
                                            <br>
                                            <hr>
...
<div id="promotion" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <img src="';echo $photostar ;;echo '" class="img-rounded" width="100%" height="100%">
